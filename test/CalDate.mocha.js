...
describe('#CalDate', function () {
  it('can return 1900-01-01 if undefined', function () {
    ...
    assert.equal(res, '1900-01-01 00:00:00')
  })
  ...
  it('can set year 2000', function () {
    ...
    var res = caldate.toString()
    assert.equal(res, '2000-01-01 00:00:00')
  })
  ...
  it('can set month February', function () {
    ...
    caldate.set({month: 2})
    var res = caldate.toString()
    assert.equal(res, '1900-02-01 00:00:00')
  })
  ...
  it('can set day 13', function () {
    ...
    caldate.set({day: 13})
    var res = caldate.toString()
    assert.equal(res, '1900-01-13 00:00:00')
  })
  ...
  it('can set hour 12', function () {
    ...
    caldate.set({hour: 12})
    var res = caldate.toString()
    assert.equal(res, '1900-01-01 12:00:00')
  })
  ...
  it('can return a ISO String', function () {
    ...
    assert.equal(res, '1900-01-01T12:00:00Z')
  })
  ...
  it('can update a date', function () {
    ...
    var res = caldate.toString()
    assert.equal(res, '2000-03-02 02:02:02')
  })
  ...
  it('can move date by timezone', function () {
    ...
    assert.equal(res, '2000-01-01T05:00:00.000Z')
  })
  ...
  it('can set offset in days', function () {
    ...
    caldate.setOffset(5)
    var res = caldate.toEndDate().toISOString()
    assert.equal(res, '2000-01-07T00:00:00Z')
  })
  ...
  it('can set undefined offset', function () {
    ...
    caldate.setOffset()
    var res = caldate.toISOString()
    assert.equal(res, '2000-01-01T00:00:00Z')
  })
  ...
  it('can set offset in hours', function () {
    ...
    var res = caldate.toISOString()
    assert.equal(res, '2000-01-01T12:00:00Z')
  })
  ...
  it('can set offset in hours using a fraction', function () {
    ...
    var res = caldate.toISOString()
    assert.equal(res, '2000-01-01T12:33:17Z')
  })
  ...
  it('can set offset in days', function () {
    ...
    var res = caldate.toISOString()
    assert.equal(res, '2000-01-02T13:12:00Z')
  })
  ...
  it('can set duration', function () {
    ...
    assert.equal(res, '2000-01-01T12:00:00Z')
    res = caldate.toEndDate().toISOString()
    assert.equal(res, '2000-01-02T11:00:00Z')
  })
